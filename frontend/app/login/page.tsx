        ...
        <div className='bg-gray-800 border border-gray-700 rounded-lg p-8'>
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
                <div>
                    ...
                    <input type="email" id="email" className='w-full px-4 py-4 bg-gray-700 border-gray-600 rounded-lg text-white placeholder-gray-400' placeholder='Enter your email Address' 
                    value={email} 
