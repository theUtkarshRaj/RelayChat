  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4">
      <div className="max-w-2xl mx-auto pt-8">
        ...
        <div className="bg-gray-800 broder-gray-700 shadow-lg">
              ...
              <div>
                ...
                {isEdit ? (
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-700 rounded-lg border border-gray-600">
                    ...
                    <button onClick={editHandler}className="flex items-center gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-800 text-white font-semibold rounded-lg">Edit</button>
                  </div>
                )}
              </div>
            </div>
