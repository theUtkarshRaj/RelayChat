...
const ChatSidebar = ({
  ...
  return (
    <aside
      className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-gray-900 border-gray-700 border-r transform overflow-x-hidden ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
            ...
            <div className="space-y-2 overflow-y-auto h-full pb-4 ">
              {users
                ...
                .map((u) => (
                  <button
                    key={u._id}
                    className="w-full text-left p-4 rounded-lg border-gray-700 hover:border-gray-600 
                  hover:bg-gray-800 transition-colors border"
                  ...
                  <div className="flex items-center gap-3 ">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {unseenCount > 0 && (
                          <div className="bg-red-600 text-white text-xs font-bold rounded-full min-w-6 h-5 flex items-center justify-center px-2">
